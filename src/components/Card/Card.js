...
const Card = ({item,Button,onPublish}) =>{ 
    ...
    return(
        <div className=" shadow-md mb-8 rounded-lg max-w-xs mx-4 bg-gray-800 border-gray-700">
                            <a href="#">
                                <img className="h-60 w-80 rounded-t-lg p-4" src="/course.png" alt="product image" />
                            </a>
                            <div className="px-5 pb-5">
                                <a href="#">
                                    <h3 className=" font-semibold text-xl tracking-tight text-white">{item.name}</h3>
                                </a>

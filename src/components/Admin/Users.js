                            ...
                            <ul className="items-center w-full border text-gray-900 bg-white  border-gray-600 flex ">
                                <li className="w-4/5 border-gray-800 ">
                                    <div className="flex items-center bg-gray-800 pl-3">
                                            <label for="Name" className="py-4 pl-3 w-full text-xl font-semibold capitalize text-gray-100 ">Tanmay Singh</label>
                                    </div>
                                </li>
                                <li className="w-4/5 border-gray-600 border-r-2 ">
                                    <div className="flex items-center pl-5">
                                        <input id="Admin" type="radio" value="" name="list-radio" className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 "/>
                                            <label for="Admin" className="py-3 ml-2 w-full text-md font-medium text-gray-900 ">Admin</label>
                                    </div>
                                </li>
                                <li className="w-4/5 border-gray-600 border-r-2 ">
                                    <div className="flex items-center pl-5">
                                        <input id="Educator" type="radio" value="" name="list-radio" className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 "/>
                                ...
                                <li className="w-4/5 border-gray-600">
                                    <div className="flex items-center pl-5">
                                        <input id="Student" type="radio" value="" name="list-radio" className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 "/>
